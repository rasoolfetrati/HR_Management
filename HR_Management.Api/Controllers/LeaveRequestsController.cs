...
namespace HR_Management.Api.Controllers
{
    ...
    public class LeaveRequestsController : ControllerBase
    {
        ...
        {
            var leaveRequest = await _mediator.Send(new GetLeaveRequestsListRequest());
        ...
        public async Task<ActionResult> ChangeApproval(int id, [FromBody] ChangeLeaveRequestApprovalDto requestApproval)
        {
            var command = new UpdateLeaveRequestCommand()
            {
                Id = id,
                ChangeLeaveRequestApprovalDto = requestApproval
            };
            await _mediator.Send(command);
            return NoContent();
        }
